...
// import '../models/enhanced_lesson_plan.dart';
...
//       // Save to Firebase
//       final docRef = await _firestore.collection('lessonPlans').add(lessonPlan.toMap());
...
//     try {
//       final updatedPlan = lessonPlan.copyWith(lastModified: DateTime.now());
...
//       final docRef = await _firestore.collection('lessonPlans').add(duplicatedPlan.toMap());
//       final savedPlan = duplicatedPlan.copyWith(id: docRef.id);
...
//              plan.keywords.any((keyword) => keyword.toLowerCase().contains(lowercaseQuery));
//     }).toList();
//   }
...
// // Enhanced LessonPlan extension for copyWith method
// extension EnhancedLessonPlanExtension on EnhancedLessonPlan {
...
//   Map<String, dynamic> toMap()// providers/lesson_provider.dart
// import 'package:flutter/material.dart';
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:firebase_auth/firebase_auth.dart';
// import '../models/enhanced_lesson_plan.dart';
